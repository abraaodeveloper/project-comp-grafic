...
function scene:create(event)
    ...
    local imginfo = display.newImageRect(sceneGroup, "assets/planeta3.png", display.contentWidth*0.8, display.contentHeight * 0.6)
    imginfo.anchorX = 0
    imginfo.anchorY = 0
    imginfo.x, imginfo.y = 80, 50

    local options1 = {
        text = "Cada um fazendo sua parte, todos sai ganhando!",
