...
function scene:create(event)
    ...
    local imginfo = display.newImageRect(sceneGroup, "assets/cidade.png", display.contentWidth*0.8, display.contentHeight * 0.5)
    imginfo.anchorX = 0
    imginfo.anchorY = 0
    imginfo.x, imginfo.y = 80, 50

    local options1 = {
        text = "Faça da sua cidade, um lugar melhor!",
        x = display.contentWidth * 0.5,
        y = display.contentHeight - (display.contentHeight * 0.35),
        width = 600,
